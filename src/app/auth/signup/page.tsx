            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="fname" className="h-12 rounded-xl bg-muted/30 border-none px-4" placeholder="Jane" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lname">Last Name</Label>
                  <Input id="lname" className="h-12 rounded-xl bg-muted/30 border-none px-4" placeholder="Doe" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" type="email" className="h-12 rounded-xl bg-muted/30 border-none px-4" placeholder="jane@example.com" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="pass">Create Password</Label>
                <Input id="pass" type="password" className="h-12 rounded-xl bg-muted/30 border-none px-4" placeholder="••••••••" />
              </div>
              <div className="pt-4 flex flex-col gap-4">
                <Button className="w-full h-14 rounded-xl font-bold text-lg">Create Account</Button>
